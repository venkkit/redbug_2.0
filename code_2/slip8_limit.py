...
limit1 = int(sys.argv[1]) #"Dogs_camp"
limit2 = int(sys.argv[2])

c_tag = str(sys.argv[3])
msg = sys.argv[4]
...
def slip(num,cus):
    ...
    d1.text((1185, 90),"#"+nums,(0,0,0),font=myFont1,align='centre')
    d1.text((680, 65),""+c_tag,(0,0,0),font=Font_tag,align='centre')
    d1.text((745, 200),str(msg),(0,0,0),anchor="mm",font=Font_msg,align='centre')
   # img.show()
